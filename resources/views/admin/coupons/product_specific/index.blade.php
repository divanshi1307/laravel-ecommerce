...
@section('content')
    ...
    <div class="container">
        <div class="title">
            ...
            <a class="btn btn-primary btn-sm float-right" href="{{ url('/admin/add_product_specific_coupon') }}" title="Add">
        ...
        <div class="content">        
            ...
            @endif
            <div class="py-2">
                <a href="{{url('admin/coupons')}}" class="btn btn-sm text-dark border border-dark mr-2">All Coupons</a>
                <a href="{{ route('product.specific.coupon.delete') }}" class="btn btn-dark btn-sm mr-2">Product Specific Coupons</a>
            </div>
            @if(count($results)>0)
                <table class="table table-bordered table-stripped">
                    ...
                    @foreach($results as $row)
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ url('/admin/add_product_specific_coupon/'.$row->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil"></i> Edit
                                </a>
                                <form method="post" action="{{ route('product.specific.coupon.delete') }}" style="display:inline">
                                    @csrf
