                                    ...
                                    <div class="row g-4">  
                                        @foreach ($products as $product)
                                            <div class="col-lg-3 col-md-4 col-sm-6"> 
                                                <div class="shop-card style-1" style="border:1px solid #e6e6e6; border-radius:10px; padding:10px;">
                                                    
                                                    <div class="dz-media" style="border-bottom:1px solid #f0f0f0; padding-bottom:10px;">
                                                        <img src="{{ asset('uploads/products/'.$product->first_image_url) }}" alt="">
                                                        <div class="shop-meta">
                                                    ...
                                                    <div class="dz-content mt-2">
                                                        <h5 class="title">{{ \Illuminate\Support\Str::limit($product->title, 30, '...') }}</h5>
