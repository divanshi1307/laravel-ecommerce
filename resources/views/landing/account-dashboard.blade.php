                    ...
                    <div class="row">
                        ...
                        <section class="col-xl-9 account-wrapper">
                            <div class="account-card">
                                <div class="m-b30">
                                    <p>Hello <strong class="text-black">{{ auth()->user()->name }}</strong> (not <strong class="text-black">{{ auth()->user()->name }}</strong>? <a href="{{ route('logout') }}" class="text-underline" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log out</a>)</p>
                                    <p>From your account dashboard you can view your <a href="{{route('orders.index')}}" class="text-underline">recent orders</a>, and <a href="{{route('account.profile')}}" class="text-underline">edit your password and account details</a>.</p>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="total-contain">
                                            ...
                                            <div class="total-detail">
                                                ...
                                                <h2 class="title">{{ $pendingOrders }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
