		...
		<div class="loader"style="display:none;"><p><i class="fa fa-spinner fa-5x fa-spin"></i></p></div>
            ...
            <form method="get" action="{{ route('locations.index') }}">
                <div class="form-group border bg-light border-info row mt-3 mb-5 mx-0">
                    ...
                    <div class="col-md-9">
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" id="state1" name="state" class="form-control" placeholder="State" value="{{ request('state') }}" autocomplete="off">
                            </div>

                            <div class="col-md-3 mb-2">
                                <label for="city">City</label>
                                <input type="text" id="city" name="city" class="form-control" placeholder="City" value="{{ request('city') }}" autocomplete="off">
                            </div>

                            <div class="col-md-3 mb-2">
                                <label for="pincode">Pincode</label>
                                <input type="text" id="pincode" name="pincode" class="form-control" placeholder="Pincode" value="{{ request('pincode') }}" autocomplete="off">
                            </div>
                    ...
                    <div class="col-md-3 d-flex align-items-end justify-content-end mb-2">
                        <div>
                            <button type="submit" class="btn btn-primary btn-sm mr-2"><i class="fa fa-filter pr-1"></i> Submit</button>
                            <a href="{{ route('locations.index') }}" class="btn btn-danger btn-sm">Clear Filters</a>
                        </div>
                    </div>
                </div>
            </form>
